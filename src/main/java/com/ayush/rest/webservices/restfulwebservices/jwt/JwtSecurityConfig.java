package com.ayush.rest.webservices.restfulwebservices.jwt;
...
public class JwtSecurityConfig {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, HandlerMappingIntrospector introspector)
		...
		return httpSecurity
				.authorizeHttpRequests(auth -> auth.mvcMatchers("/","/authenticate").permitAll()
	...
	public UserDetailsService userDetailsService() {
		UserDetails user = User.withUsername("ayush").password("{noop}password").authorities("read").roles("USER")
				.build();
